...
namespace Final_Project
{
    public partial class FrmCustomerRecords : Form
    {
        ...
        public void getdata()
        {
            da = new SqlDataAdapter("select * from Customers", cs.cn);
            dt = new DataTable();
            da.Fill(dt);
        }
        ...
        public void display()
        {
            if (dt.Rows.Count > 0)
            {
                txtid.Text = dt.Rows[i]["Cid"].ToString();
        ...
        private void btnsave_Click(object sender, EventArgs e)
        {
            ...
            if (txtname.Text != "" && txtadd.Text != "" && txtmobile.Text != "" && txtemail.Text != "" && lblname.Text == "" && lbladdress.Text == "" && lblmobile.Text == "" && lblemail.Text == "" )
            {
                ...
                {
                    //code for new member
                    sqlq = "insert into Customers values(" + auto + ",'"+ txtid.Text +"','" + txtname.Text + "','" + txtadd.Text + "'," + txtmobile.Text + ",'" + txtemail.Text + "')";
                    cmd = new SqlCommand();
                ...
                {
                    //code for update emp
                    sqlq = "Update Customers set Name='" + txtname.Text + "',Address='" + txtadd.Text + "',MobileNo=" + txtmobile.Text + ",EmailID='" + txtemail.Text + "' where Cid='" + txtid.Text + "' ";
                    cmd = new SqlCommand();
                    cmd.Connection = cs.cn;
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = sqlq;
        ...
        private void btnremove_Click(object sender, EventArgs e)
        {
            if (txtname.Text != "")
            {
                ...
                {
                    cs.ec();
                    String sqlq = "Delete from Customers where Cid= '"+ txtid.Text +"' ";
                    cmd = new SqlCommand();
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = sqlq;
                    cmd.Connection = cs.cn;
        ...
        private void txtname_Leave(object sender, EventArgs e)
        {
            if (txtname.Text == "")
            {
                lblname.Text = "Enter Customer Name.";
            }
            else
            {
                lblname.Text = "";
        ...
        private void txtadd_Leave(object sender, EventArgs e)
        {
            if (txtadd.Text == "")
            {
                lbladdress.Text = "Enter Customer Address.";
            }
            else
            {
                lbladdress.Text = "";
